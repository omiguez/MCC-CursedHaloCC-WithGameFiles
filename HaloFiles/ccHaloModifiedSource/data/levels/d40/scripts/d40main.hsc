...
(script continuous trench_jeep_test
	...
	(if 
		(or
			...
			(vehicle_test_seat_list trench_jeep2 "G-driver" (players))
			(vehicle_test_seat_list trench_jeep3 "W-driver" (players))
			(vehicle_test_seat_list trench_jeep4 "W-driver" (players))
			(vehicle_test_seat_list trench_jeep5 "W-driver" (players))
			(vehicle_test_seat_list trench_jeep6 "W-driver" (players))
			(vehicle_test_seat_list trench_jeep7 "G-Driver" (players))
			(vehicle_test_seat_list trench_jeep8 "W-driver" (players))
			(vehicle_test_seat_list trench_jeep9 "W-driver" (players))
			(vehicle_test_seat_list trench_jeep10 "W-driver" (players))
			(vehicle_test_seat_list trench_jeep11 "W-driver" (players))
			(vehicle_test_seat_list trench_jeep12 "W-driver" (players))
			(vehicle_test_seat_list trench_jeep13 "W-driver" (players))
			(vehicle_test_seat_list trench_jeep14 "W-driver" (players))
		)
...
;	(if debug (print "enc7_7"))
	...
	(ai_place_tracked enc7_7_cov/left_gunner)
	(ai_place_tracked enc7_7_cov/right_gunner)
...
;	(if debug (print "enc7_1"))
	...
	(ai_place_tracked enc7_7_cov/R3)
	(ai_place_tracked enc7_7_cov/R7)
	(ai_place_tracked enc7_7_flood)
...
;	(if debug (print "enc6_10"))
	...
	; Place the AI
	(ai_place_tracked enc6_9_flood/infsB)
)
...
;	(if debug (print "enc6_9"))
	...
	; Place the AI
	(ai_place_tracked enc6_9_flood/infsA)
	(ai_place_tracked enc6_9_flood/carriers)
...
;	(effect_new explosion_large enc6_5_blast10)
	...
	; Place em
	(ai_place_tracked enc6_5_cov/evacs1)
	(ai_place_tracked enc6_5_cov/evacs2)
	(ai_place_tracked enc6_5_cov/gunner)
;	(ai_place_tracked enc6_5_cov/gunner_grunts)
...
;	(if debug (print "enc6_5_1"))
	...
	; Place
	(ai_place_tracked enc6_5_flood/infsB)
)
...
;	(if debug (print "enc6_4_8"))
	...
	; Place units
	(ai_place_tracked enc6_5_cov/grunts_advance)
	(ai_place_tracked enc6_5_flood/infsA)
	...
	(if 
		...
		(begin
			(ai_place_tracked enc6_5_cov/fuel_rod_grunts)
...
;	(if debug (print "enc6_3_4"))
	...
	; Place
	(ai_place_tracked enc6_3_sents/squadC)
	(ai_place_tracked enc6_4_flood/squadA)
	(ai_place_tracked enc6_4_flood/squadB)
	(ai_place_tracked enc6_4_flood/squadC)
	(ai_place_tracked enc6_4_flood/infs)
...
;	(if debug (print "enc6_3_2"))
	...
	; Place
	(ai_place_tracked enc6_3_flood/infsB)
...
;	(if debug (print "enc6_3_1"))
	...
	; Place
	(ai_place_tracked enc6_3_sents/squadB)
)
...
;	(if debug (print "enc6_3"))
	...
	; Place
	(ai_place_tracked enc6_3_sents/squadA)
	(ai_place_tracked enc6_3_flood/combatsA)
	(ai_place_tracked enc6_3_flood/infsA)
...
;	(if debug (print "enc6_2_8"))
	...
	; Place
	(ai_place_tracked enc6_2_sents/squadF)
...
;	(if debug (print "enc6_2_7"))
	...
	; Place
	(ai_place_tracked enc6_2_sents/squadE)
...
;	(if debug (print "enc6_2_5"))
	...
	; Place 
	(ai_place_tracked enc6_2_flood/infs2)
...
;	(if debug (print "enc6_2_2"))
	...
	; Place
	(ai_place_tracked enc6_2_sents/squadD)
...
;	(if debug (print "enc6_2_1"))
	...
	; Place
	(ai_place_tracked enc6_2_sents/squadC)
...
;	(if debug (print "enc6_2"))
	...
	; Place advance units
	(ai_place_tracked enc6_2_flood/infs)
	(ai_place_tracked enc6_2_flood/combats)
	(ai_place_tracked enc6_2_sents/squadA)
	(ai_place_tracked enc6_2_sents/squadB)
...
;	(if debug (print "enc6_1_6"))
	...
	; Place 'n kill
	(ai_place_tracked enc6_1_flood/fodder6)
	...
	; Fodder
	(sleep 30)
	(ai_place_tracked enc6_1_flood/fodder4)
)
...
;	(if debug (print "enc6_1_4"))
	...
	; Place units
	(ai_place_tracked enc6_1_flood/fodder2)
...
;	(if debug (print "enc6_1_3"))
	...
	; Place units
	(ai_place_tracked enc6_1_flood/fodder3)
)
...
;	(if debug (print "enc6_1_2"))
	...
	; PLace
	(ai_place_tracked enc6_1_flood/fodder5)
...
;	(if debug (print "enc6_1_1"))
	...
	(ai_place_tracked enc6_1_flood/squadD)
)
...
;	(if debug (print "enc6_1"))
	...
	(ai_place_tracked enc6_1_flood/squadB)
	(ai_place_tracked enc6_1_flood/fodder1)
...
;	(if debug (print "enc6_0_1"))
	...
	(ai_place_tracked enc6_1_flood/squadA)
	(ai_place_tracked enc6_1_flood/squadC)
...
;	(if debug (print "section6"))
	...
	(object_create_containing "trench_health")
...
(script dormant enc5_2
	...
	(ai_place_tracked enc5_2_cov/elevator_squad)
...
;	(if debug (print "Encounter 5.1 - South 1 to 2..."))
	...
	; Place the foos
	(ai_place_tracked enc5_1_sents/s12)
)
...
(script static void enc5_1_s12_spawn
	...
	(if (<= (ai_living_count enc5_1_infs/s12) min_infection_spawn)
		(ai_place_tracked enc5_1_infs/s12)
	)
)
(script static void enc5_1_s23_spawn
	...
	(if (<= (ai_living_count enc5_1_infs/s23) min_infection_spawn)
		(ai_place_tracked enc5_1_infs/s23)
	)
)
(script static void enc5_1_n12_spawn
	...
	(if (<= (ai_living_count enc5_1_infs/n12) min_infection_spawn)
		(ai_place_tracked enc5_1_infs/n12)
	)
)
(script static void enc5_1_n23_spawn
	...
	(if (<= (ai_living_count enc5_1_infs/n23) min_infection_spawn)
		(ai_place_tracked enc5_1_infs/n23)
	)
)
...
(script static void enc5_1_infs_floor0
	...
	(if (volume_test_objects enc5_1_north (players))
		...
		(ai_place_tracked enc5_1_infs/n2)
		
		; South, place flood on south floor 2
		(if (volume_test_objects enc5_1_south (players)) (ai_place_tracked enc5_1_infs/s2))
	)
)
; Infs, floor 1
...
(script static void enc5_1_infs_floor2
	...
	(if (volume_test_objects enc5_1_north (players))
		...
		(ai_place_tracked enc5_1_infs/n0)
		
		; South, place flood on south floor 0
		(if (volume_test_objects enc5_1_south (players))(ai_place_tracked enc5_1_infs/s0))
	)
)
; Infs, floor 3
(script static void enc5_1_infs_floor3
	...
	(if (volume_test_objects enc5_1_north (players))
		...
		(ai_place_tracked enc5_1_infs/n1)
		
		; South, place flood on south floor 1
		(if (volume_test_objects enc5_1_south (players))(ai_place_tracked enc5_1_infs/s1))
	)
)
; Inf spawner
...
(script static void enc5_1_flood_spawn
	...
	(if 
		...
		(if (volume_test_objects_all enc5_1_north (players))
			(ai_place_tracked enc5_1_flood/upper_south)
			(ai_place_tracked enc5_1_flood/upper_north)
		)
	)
)
...
(script static void enc5_1_elevator_spawn
	(if (volume_test_objects_all enc5_1_main (players))
		(ai_place_tracked enc5_1_cov/elevator_squad)
	)
)
		...
		(begin
			...
			(if 		
				...
				(begin 
					...
					(sleep 300)
					(ai_place_tracked enc5_1_sents/north)
				)
			)
		)
	)
		...
		(begin
			...
			(if 		
				...
				(begin 
					...
					; Wait a moment, and place the sentinels
					(sleep 300)
					(ai_place_tracked enc5_1_sents/south)
				)
			)
		)		
	)
...
;	(if debug (print "Encounter 5.1..."))
	...
	(ai_place_tracked enc5_1_monitor)
...
;	(if debug (print "Encounter 4.3..."))
	...
	(ai_place_tracked enc4_3_flood/stealth_combats)
	...
	(ai_place_tracked enc4_3_flood/second_wave)
	...
	(if (<= enc4_2_limiter 7)
		...
		(begin
			...
			(if (< (ai_living_count enc4_2_flood/infs) min_infection_spawn) (begin 
				(ai_place_tracked enc4_2_flood/infs)
			))
		)
	)
...
;	(if debug (print "Encounter 4.1..."))
	...
	; Wait a few seconds
	(ai_place_tracked enc4_1_cov)
	(ai_place_tracked enc4_1_flood)
...
(script continuous enc3_6_manager
	...
	(if (< (ai_living_count enc3_6_flood/infs) min_infection_spawn) (begin 
		(ai_place_tracked enc3_6_flood/infs)
	))
...
;	(wake enc3_6)
	...
	(ai_place_tracked enc3_6_flood/stalling_infs)
...
(script continuous enc3_5_manager
	...
	(if (< (ai_living_count enc3_5_flood/infs) min_infection_spawn) (begin 
		(ai_place_tracked enc3_5_flood/infs)
	))
...
;	(if debug (print "Encounter 3.5..."))
	...
	; Place the units, make them see
	(ai_place_tracked enc3_5_flood/sacrifices)
...
;	(if debug (print "Encounter 3.4..."))
	...
	; Place the units
	(ai_place_tracked enc3_4_monitor/monitor)
	(sleep 60)
	(ai_place_tracked enc3_4_monitor/sents)
...
;	(if debug (print "Encounter 3.3..."))
	...
	(ai_place_tracked enc3_3_flood/combats)
	(ai_place_tracked enc3_3_flood/infs)
	(ai_place_tracked enc3_3_sents)
	...
	(if (>= (device_get_position enc3_3_door1) 0.9)
		(ai_place_tracked enc3_3_flood/door_infs1)
		; Elseif
		(if (>= (device_get_position enc3_3_door2) 0.9)
			(ai_place_tracked enc3_3_flood/door_infs2)
		)
	)
	...
	(ai_place_tracked enc3_3_flood/combats2)
)
...
;	(if debug (print "Encounter 3.1..."))
	...
	(ai_place_tracked enc3_1_flood)
	(ai_place_tracked enc3_1_sents)
	...
	(ai_place_tracked enc3_1_flood/infs2)
)
...
;	(if debug (print "Encounter 2.7..."))
	...
	; Place the units, make them love!
	(ai_place_tracked enc2_7_cov)
	(ai_place_tracked enc2_7_flood)
)
...
;	(if debug (print "Encounter 2.5..."))
	...
	; Place the units, make them love the player!
	(ai_place_tracked enc2_5_cov)
	(ai_place_tracked enc2_5_flood)
	(sleep 30)
	(D40_020_Cortana)
...
(script static void enc2_2_hunter1
	(ai_place_tracked enc2_2_cov/hunter1)
	(device_set_position enc2_1_door2 1)
)
(script static void enc2_2_hunter2
	(ai_place_tracked enc2_2_cov/hunter2)
...
;	(if debug (print "Encounter 2.2..."))
	...
	(ai_place_tracked enc2_2_flood/sacrifices)
	(ai_place_tracked enc2_2_flood/combats)
	
	; Sleep, then place the Cov
	(sleep_until (volume_test_objects enc2_2 (players)))
	(ai_place_tracked enc2_2_cov/squad1)
	(ai_place_tracked enc2_2_cov/squad2)
	...
	; Place the infs
	(ai_place_tracked enc2_2_flood/infs)
...
(script continuous enc1_4_manager
	...
	(if (< (ai_living_count enc1_4_flood/infs) min_infection_spawn) (begin 
		(ai_place_tracked enc1_4_flood/infs)
	))
)
...
;	(if debug (print "Encounter 1.4..."))
	...
	(ai_place_tracked enc1_4_flood/init_combats)
	(ai_place_tracked enc1_4_flood/init_infs)
...
;	(if debug (print "Encounter 1.2..."))
	...
	(ai_place_tracked enc1_2_flood)
	
	; Place the sentinels
	(ai_place_tracked enc1_2_sents)
)
...
;	(if debug (print "Encounter 1.1..."))
	...
	; Place the units, make them love each other!
	(ai_place_tracked enc1_1_sents)
	(ai_place_tracked enc1_1_flood)
...
(script startup mission
	; Fade to black
	(fade_out 0 0 0 0) (sleep 1)

	; Initialize scripts
	(coop_control) (sleep 1)
	(diff_control) (sleep 1) ;; I literally have no idea why we need these sleeps but tag test crashes so fuck it idk fuck fuck fuck

   (if (mcc_mission_segment "cine1_intro") (sleep 1)) (sleep 1)
	...
	(wake section5)	
	(wake section6)	
	(wake section7) (sleep 1)
	(wake mission_grunt_kart_a)

	; Run opening cinematics
	;; no longer skippable since i changed some stuff in cursed halo here
	(set cinematic_ran true)
	(wake intro_cutscene_aux)
	(cinematic_intro)
	 
	; Start music
	;; (sound_looping_start "levels\d40\music\d40_01" none 1) ;; starting this in the intro cutscene much earlier because changes
