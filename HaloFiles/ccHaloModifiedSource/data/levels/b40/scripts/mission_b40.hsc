...
(script static void enc_a1_initial
	(ai_place_tracked a1_cov/elites_door)
	(ai_place_tracked a1_cov/elites_middle)
	(ai_place_tracked a1_cov/grunts_middle)
	(sleep 1)
	(objects_predict (ai_actors a1_cov))
	)

(script static void enc_a1
	(ai_place_tracked a1_cov/grunts_ledge)
	(ai_place_tracked a1_cov/elites_left)
	(ai_place_tracked a1_cov/elites_right)

	(begin_random
		(if a1_spawn
			(begin (ai_place_tracked a1_cov/grunts_left)
				  (set a1_spawn_counter (+ 1 a1_spawn_counter))
				  (if (= a1_spawn_counter a1_squad_index) (set a1_spawn false))))
		(if a1_spawn
			(begin (ai_place_tracked a1_cov/jackals_left)
				  (set a1_spawn_counter (+ 1 a1_spawn_counter))
				  (if (= a1_spawn_counter a1_squad_index) (set a1_spawn false)))))
	...
	(begin_random
		(if a1_spawn
			(begin (ai_place_tracked a1_cov/grunts_right)
				  (set a1_spawn_counter (+ 1 a1_spawn_counter))
				  (if (= a1_spawn_counter a1_squad_index) (set a1_spawn false))))
		(if a1_spawn
			(begin (ai_place_tracked a1_cov/jackals_right)
				  (set a1_spawn_counter (+ 1 a1_spawn_counter))
				  (if (= a1_spawn_counter a1_squad_index) (set a1_spawn false)))))
	(set a1_spawn_counter 0)
	(set a1_spawn true)
...
(script static void enc_a1_rear
	(ai_place_tracked a1_cov/grunts_rear)
	(sleep 1)
	(objects_predict (ai_actors a1_cov))
	)
...
(script dormant enc_a_bridge
	(ai_place_tracked a_bridge/grunts_a)
	(ai_place_tracked a_bridge/jackals_a)
	(ai_place_tracked a_bridge/elites_a)
	(sleep 1)
	(objects_predict (ai_actors a_bridge))
	)

(script dormant enc_a_bridge_second
	(ai_place_tracked a_bridge/grunts_low)
	(ai_place_tracked a_bridge/jackals_m)
	(ai_place_tracked a_bridge/shotgun_jackal_rush)  ;; cursed halo stuff
	(ai_place_tracked a_bridge/turret_grunts)
	(sleep 1)
	(objects_predict (ai_actors a_bridge))
	)

(script dormant enc_a_bridge_reins_sword
	(ai_place_tracked a_bridge/elites_reins)
	)

(script dormant enc_a_bridge_reins	
	(begin_random
		(if a_bridge_rein
			(begin (ai_place_tracked a_bridge/grunts_reins)
				  (set a_bridge_rein_counter (+ 1 a_bridge_rein_counter))
				  (if (= a_bridge_rein_counter a_bridge_rein_index) (set a_bridge_rein false))))
		(if a_bridge_rein
			(begin (ai_place_tracked a_bridge/jackals_reins)
				  (set a_bridge_rein_counter (+ 1 a_bridge_rein_counter))
				  (if (= a_bridge_rein_counter a_bridge_rein_index) (set a_bridge_rein false)))))
...
(script dormant ini_ext_a_banshee
	...
	(ai_place_tracked ext_a_area_a_cov/banshee_a_pilot)
...
(script dormant enc_a2_top_cov
	(ai_place_tracked a2_top_cov/elites_a)
	(ai_place_tracked a2_top_cov/grunt_sniper)
	(ai_place_tracked a2_top_cov/grunts_a)
	(ai_place_tracked a2_top_cov/grunts_ledge)
	(if (or (= (game_difficulty_get) hard)
		   (= (game_difficulty_get) impossible)) (ai_place_tracked a2_top_cov/hunters))
...
;	(ai_place_tracked a2_bottom_cov/engineers)
	(ai_place_tracked a2_bottom_cov/jackals_inner)
	(ai_place_tracked a2_bottom_cov/grunts_a)
	(ai_place_tracked a2_bottom_cov/elites_a)
	(ai_place_tracked a2_bottom_cov/jackals_a)
	(ai_place_tracked a2_bottom_cov/grunts_lift)
	(sleep 1)
	(objects_predict (ai_actors a2_bottom_cov))
	)

(script dormant enc_a2_tube
	(ai_place_tracked a2_bottom_cov/grunts_tub)
	(sleep 1)
	(objects_predict (ai_actors a2_bottom_cov))
	)
...
(script dormant enc_ext_a_cov
	(ai_place_tracked ext_a_area_a_cov/grunts_a)
;	(ai_place_tracked ext_a_area_a_cov/elites_a)
;	(ai_place_tracked ext_a_area_a_cov/elites_e)
	(ai_place_tracked ext_a_area_a_cov/elites_k)
	(ai_place_tracked ext_a_area_a_cov/jackals_k1)
	
	(begin_random
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_a_cov/jackals_e)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false))))
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_a_cov/grunts_e)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false)))))
...
(script dormant enc_ext_a_marines
	(ai_place_tracked ext_a_area_a_marines/marines_ini)
;	(ai_place_tracked ext_a_area_a_marines/sarge)
	(sleep 1)
...
(script dormant enc_ext_a_a_cov_second
	(if (< (ai_living_count ext_a_area_a_cov) 10)
		(ai_place_tracked ext_a_area_a_cov/jackals_o)
		(ai_place_tracked ext_a_area_a_cov/elites_o))
	(sleep 1)
	(if (< (ai_living_count ext_a_area_a_cov) 10)
		(ai_place_tracked ext_a_area_a_cov/jackals_q))
	)

(script dormant enc_ext_a_area_b
	(ai_place_tracked ext_a_area_b_cov/ghost_a_pilot)
	(ai_place_tracked ext_a_area_b_cov/ghost_b_pilot)
	(ai_place_tracked ext_a_area_b_cov/elites_u)
	(ai_place_tracked ext_a_area_b_cov/elites_e)
	(ai_place_tracked ext_a_area_b_cov/grunts_e)
	(ai_place_tracked ext_a_area_b_cov/jackals_e)

	(begin_random
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_b_cov/grunts_u)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false))))
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_b_cov/jackals_u)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false)))))
	(set ext_a_spawn_counter 0)
	(set ext_a_spawn true)
...
(script dormant enc_ext_a_area_b_2
	(ai_place_tracked ext_a_area_b_cov/elites_q)
	(ai_place_tracked ext_a_area_b_cov/elites_k)

	(begin_random
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_b_cov/grunts_q)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false))))
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_b_cov/jackals_q)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false)))))
	(set ext_a_spawn_counter 0)
	(set ext_a_spawn true)
	...
	(begin_random
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_b_cov/grunts_k)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false))))
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_b_cov/jackals_k)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false)))))
	(set ext_a_spawn_counter 0)
	(set ext_a_spawn true)
...
(script dormant enc_ext_a_area_b_mar
	(ai_place_tracked ext_a_area_b_marines/marines_ini)
	(ai_place_tracked ext_a_area_b_marines/sarge)
	(sleep 1)
...
(script dormant enc_ext_a_area_c_cov
	(begin_random
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_c_cov/grunts_w)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false))))
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_c_cov/elites_u)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false))))
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_c_cov/elites_w)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false))))
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_c_cov/grunts_y)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false))))
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_c_cov/jackals_y)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false))))
		(if ext_a_spawn
			(begin (ai_place_tracked ext_a_area_c_cov/jackals_u)
				  (set ext_a_spawn_counter (+ 1 ext_a_spawn_counter))
				  (if (= ext_a_spawn_counter ext_a_squad_index) (set ext_a_spawn false)))))
	(set ext_a_spawn_counter 0)
	(set ext_a_spawn true)

	(ai_place_tracked ext_a_area_c_cov/hunters)
	(ai_place_tracked ext_a_area_c_cov/jackals_q)
	(ai_place_tracked ext_a_area_c_cov/grunts_u)
	(sleep 1)
...
(script dormant crev_ent_turret_a
	...
	(ai_place_tracked ext_a_area_c_cov/turret_a_gunners)
...
(script dormant crev_ent_turret_b
	...
	(ai_place_tracked ext_a_area_c_cov/turret_b_gunners)
...
(script dormant crev_ent_turret_c
	...
	(ai_place_tracked ext_a_area_c_cov/turret_c_gunners)
...
(script dormant crev_ent_turret_d
	...
	(ai_place_tracked ext_a_area_c_cov/turret_d_gunners)
...
(script dormant crev_ent_turret_e
	...
	(ai_place_tracked ext_a_area_c_cov/turret_e_gunners)
...
(script dormant ini_ext_a_area_c_banshee
	(ai_place_tracked ext_a_area_c_cov/banshee_pilot)
...
(script dormant enc_crevasse
	(ai_place_tracked crevasse_cov_a/jackals_w)
	(ai_place_tracked crevasse_cov_a/elites_k)
	(ai_place_tracked crevasse_cov_a/turret_a_gunners)
	(ai_place_tracked crevasse_cov_a/turret_b_gunners)

	(ai_place_tracked crevasse_cov_b/turret_c_gunners)
	(ai_place_tracked crevasse_cov_b/hunters)
	(ai_place_tracked crevasse_cov_b/jackals_g)
	(ai_place_tracked crevasse_cov_b/grunts_a)
	(ai_place_tracked crevasse_cov_b/elites_k)
	(sleep 1)
...
(script dormant enc_crevasse_reins
	(ai_place_tracked crevasse_cov_b/elites_reins)
	(ai_place_tracked crevasse_cov_b/grunts_reins)
	(sleep 1)
	(objects_predict (ai_actors crevasse_cov_b))
	)
...
(script dormant enc_ext_b_tunnel
	(ai_place_tracked ext_b_area_a_cov/elites_a)
	(ai_place_tracked ext_b_area_a_cov/grunts_a)
	(ai_place_tracked ext_b_area_a_cov/jackals_c)
	(ai_place_tracked ext_b_area_a_cov/jackals_d)
	(sleep 1)
...
(script dormant enc_ext_b_a_trigger_b
	(if (< (ai_living_count ext_a_area_a_cov) 4)
		(begin
			(ai_place_tracked ext_b_area_a_cov/elites_u)
			(ai_place_tracked ext_b_area_a_cov/grunts_u)
			(ai_place_tracked ext_b_area_a_cov/jackals_u)
			(ai_place_tracked ext_b_area_a_cov/elites_v)
			(ai_place_tracked ext_b_area_a_cov/grunts_v)
			(ai_place_tracked ext_b_area_a_cov/jackals_v)
			(ai_place_tracked ext_b_area_a_cov/elites_j)
			(sleep 1)
			(objects_predict (ai_actors ext_b_area_a_cov))))
	)
...
(script dormant enc_ext_b_a_trigger_c
	(if (< (ai_living_count ext_a_area_a_cov) 4)
		(begin
			(ai_place_tracked ext_b_area_a_cov/elites_s)
			(ai_place_tracked ext_b_area_a_cov/grunts_s)
			(ai_place_tracked ext_b_area_a_cov/jackals_s)
			(ai_place_tracked ext_b_area_a_cov/elites_t)
			(ai_place_tracked ext_b_area_a_cov/grunts_t)
			(ai_place_tracked ext_b_area_a_cov/jackals_t)
			(sleep 1)
			(objects_predict (ai_actors ext_b_area_a_cov))))
	)
...
(script dormant enc_ext_b_b
	(if (< (ai_living_count ext_a_area_b_cov) 8)
		(begin
			(ai_place_tracked ext_b_area_b_cov/grunts_a)
			(ai_place_tracked ext_b_area_b_cov/grunts_c)
			(ai_place_tracked ext_b_area_b_cov/elites_c)))
	(ai_place_tracked ext_b_area_b_cov/jackals_b)
	(ai_place_tracked ext_b_area_b_cov/turret_gunner_a)
	(ai_place_tracked ext_b_area_b_cov/turret_gunner_b)
	(ai_place_tracked ext_b_area_b_cov/snipers)
...
(script dormant enc_ext_b_b_marines
	(ai_place_tracked ext_b_marines/marines_tunnel)
	(ai_place_tracked ext_b_marines/sarge)

;	(ai_place_tracked ext_b_area_b_cov/elites_e)
;	(ai_place_tracked ext_b_area_b_cov/grunts_e)
;	(ai_place_tracked ext_b_area_b_cov/jackals_e)
	(ai_place_tracked ext_b_area_b_cov/hunters)
	(sleep 1)
	(objects_predict (ai_actors ext_b_area_b_cov))
...
(script dormant enc_ext_b_cave
	(ai_place_tracked ext_b_area_b_cov/stealth_i)
	(if (< (ai_living_count ext_b_area_b_cov) 8)
		(begin
			(ai_place_tracked ext_b_area_b_cov/grunts_j)
			(ai_place_tracked ext_b_area_b_cov/jackals_l)))
	(sleep 1)
	(objects_predict (ai_actors ext_b_area_b_cov))
	)

(script dormant enc_ext_b_b_final
	(ai_place_tracked ext_b_area_b_cov/elites_o)
	(ai_place_tracked ext_b_area_b_cov/grunts_m)
	(ai_place_tracked ext_b_area_b_cov/turret_gunner_c)
	(ai_go_to_vehicle ext_b_area_b_cov/turret_gunner_c ext_b_b_turret_c "gunner")
	
;	(ai_place_tracked ext_b_area_c_cov/elites_a)
;	(ai_place_tracked ext_b_area_c_cov/grunts_a)
	(sleep 1)
	(objects_predict (ai_actors ext_b_area_b_cov))
...
(script dormant enc_ext_b_c_ini
	(if (< (ai_living_count ext_b_area_c_cov) 3)
		(begin
			(ai_place_tracked ext_b_area_c_cov/elites_a)
			(ai_place_tracked ext_b_area_c_cov/grunts_a)))
	(ai_place_tracked ext_b_area_c_cov/grunts_b)
	(ai_place_tracked ext_b_area_c_cov/turret_gunner_a)
	(sleep 1)
...
(script dormant enc_ext_b_c_final
	(ai_place_tracked ext_b_area_c_cov/elites_b)
	(ai_place_tracked ext_b_area_c_cov/turret_gunner_b)
	(ai_place_tracked ext_b_area_c_cov/turret_gunner_c)
	(ai_place_tracked ext_b_area_c_cov/ghost_pilot_a)
	(ai_place_tracked ext_b_area_c_cov/ghost_pilot_b)
	(sleep 1)
...
(script dormant enc_ext_b_c_reins
	(ai_place_tracked ext_b_area_c_cov/elites_d)
	(ai_place_tracked ext_b_area_c_cov/elites_e)
	(sleep 1)
	(objects_predict (ai_actors ext_b_area_c_cov))
	)
...
(script dormant ini_ext_b_tower
	...
	(ai_place_tracked ext_b_area_a_cov/elites_tower)
	(sleep 1)
	(objects_predict (ai_actors ext_b_area_a_cov/elites_tower))
	)
	
(script dormant ini_ext_b_second
	(ai_place_tracked ext_b_area_a_cov/turret_a_gunner)
	(ai_place_tracked ext_b_area_a_cov/turret_b_gunner)
	(ai_place_tracked ext_b_area_a_cov/ghost_pilot_c)
	(ai_place_tracked ext_b_area_a_cov/ghost_pilot_d)
	(ai_place_tracked ext_b_area_a_cov/wraith_gunner)
...
(script dormant ini_ext_b_trigger_d
	(ai_place_tracked ext_b_area_a_cov/hunter_o)
	(ai_place_tracked ext_b_area_a_cov/hunter_q)
	...
	(if (and (= (ai_living_count ext_b_a_ghost_a) 0)
	    ...
	    (begin  (ai_place_tracked ext_b_area_a_cov/ghost_pilot_e) (ai_place_tracked ext_b_area_a_cov/ghost_pilot_f)))
...
(script dormant ini_pipe_cov
	...
	(ai_place_tracked ext_b_area_c_cov/elites_c)
	(sleep 1)
	(objects_predict (ai_actors ext_b_area_c_cov))
...
(script dormant ini_ext_b_banshee_a
	(ai_place_tracked ext_b_area_a_cov/banshee_pilot)
...
(script dormant ini_ext_b_banshee_b
	(ai_place_tracked ext_b_area_c_cov/banshee_pilot)
...
(script dormant enc_b3_bottom_cov
	(ai_place_tracked b3_bottom_cov/elite_guards)
	(ai_place_tracked b3_bottom_cov/grunts_a)
	(ai_place_tracked b3_bottom_cov/grunts_e)
	(ai_place_tracked b3_bottom_cov/grunts_g)
	(ai_place_tracked b3_bottom_cov/grunts_i)
	(ai_place_tracked b3_bottom_cov/grunts_m)
	(sleep 1)
	(objects_predict (ai_actors b3_bottom_cov))
	)

(script dormant enc_b3_lift_cov
	(ai_place_tracked b3_top_cov/jackals_lift)
	(sleep 1)
	(objects_predict (ai_actors b3_top_cov))
	)

(script dormant enc_b3_top_cov
	(ai_place_tracked b3_top_cov/jackals_lift_room)
	(ai_place_tracked b3_top_cov/elite_tree)
	(ai_place_tracked b3_top_cov/elite_commander)
	(ai_place_tracked b3_top_cov/grunts_a)
	(ai_place_tracked b3_top_cov/jackals_a)

	(begin_random
		(if b3_top_spawn
			(begin (ai_place_tracked b3_top_cov/grunts_c1)
				  (set b3_top_spawn_counter (+ 1 b3_top_spawn_counter))
				  (if (= b3_top_spawn_counter b3_top_squad_index) (set b3_top_spawn false))))
		(if b3_top_spawn
			(begin (ai_place_tracked b3_top_cov/grunts_c2)
				  (set b3_top_spawn_counter (+ 1 b3_top_spawn_counter))
				  (if (= b3_top_spawn_counter b3_top_squad_index) (set b3_top_spawn false))))
		(if b3_top_spawn
			(begin (ai_place_tracked b3_top_cov/jackals_c)
				  (set b3_top_spawn_counter (+ 1 b3_top_spawn_counter))
				  (if (= b3_top_spawn_counter b3_top_squad_index) (set b3_top_spawn false)))))
...
(script dormant enc_b3_top_cov_reins
	(ai_place_tracked b3_top_cov/elites_reins)
	(ai_place_tracked b3_top_cov/grunts_reins)
	(ai_place_tracked b3_top_cov/jackals_reins)
	(sleep 1)
...
(script dormant enc_b3_bridge
	(ai_place_tracked b3_bridge/grunts_a)
	(ai_place_tracked b3_bridge/grunts_c)
	(ai_place_tracked b3_bridge/jackals_c)
	(ai_place_tracked b3_bridge/grunts_g)
	(ai_place_tracked b3_bridge/jackals_g)
	(ai_place_tracked b3_bridge/elites_e)
	
	(ai_place_tracked b4_bridge/b3_grunts_c)
	(ai_place_tracked b4_bridge/b3_grunts_e)
	(ai_place_tracked b4_bridge/b3_grunts_g)
	(sleep 1)
...
(script dormant enc_b3_bridge_reins
	(ai_place_tracked b3_bridge/stealth_elites)
	(ai_place_tracked b3_bridge/grunts_reins)
	(sleep 1)
	(objects_predict (ai_actors b3_bridge))
	)
...
(script dormant enc_b4_a
	(ai_place_tracked b4_a_cov/elites_1)
	(ai_place_tracked b4_a_cov/elites_2)
	(ai_place_tracked b4_a_cov/elites_3)
	(ai_place_tracked b4_a_cov/elites_4)
	(sleep 1)
	(objects_predict (ai_actors b4_a_cov))
	)

(script dormant enc_b4_b
	(ai_place_tracked b4_b_cov/elites_w)
	(ai_place_tracked b4_b_cov/grunts_w)
	(ai_place_tracked b4_b_cov/elites_a)
	(ai_place_tracked b4_b_cov/grunts_m)
	(ai_place_tracked b4_b_cov/grunts_g)
	(ai_place_tracked b4_b_cov/jackals_k)
	(sleep 1)
	(objects_predict (ai_actors b4_b_cov))
	)

(script dormant enc_b4_hall
	(ai_place_tracked b4_hall/grunts)
	(ai_place_tracked b4_hall/jackals)
	(sleep 1)
...
(script dormant enc_b4_bridge_ini
	(ai_place_tracked b3_bridge/hunters)
	(ai_place_tracked b4_bridge/elites_c)

	(begin_random
		(if b4_bridge_spawn
			(begin (ai_place_tracked b4_bridge/grunts_a)
...
(script dormant enc_b4_bridge_reins_a
	(ai_place_tracked b4_bridge/elites_g)
	
	(begin_random
		(if b4_bridge_spawn
			(begin (ai_place_tracked b4_bridge/grunts_e)
				  (set b4_bridge_spawn_counter (+ 1 b4_bridge_spawn_counter))
				  (if (= b4_bridge_spawn_counter b4_bridge_squad_index) (set b4_bridge_spawn false))))
		(if b4_bridge_spawn
			(begin (ai_place_tracked b4_bridge/jackals_e)
				  (set b4_bridge_spawn_counter (+ 1 b4_bridge_spawn_counter))
				  (if (= b4_bridge_spawn_counter b4_bridge_squad_index) (set b4_bridge_spawn false)))))
	(set b4_bridge_spawn_counter 0)
	(set b4_bridge_spawn true)
...
(script dormant enc_b4_bridge_reins_b
	(ai_place_tracked b4_bridge/stealth_elites)
	(sleep 1)
	(objects_predict (ai_actors b4_bridge))
	)
...
(script dormant enc_b5_a
	(ai_place_tracked b5_a_cov/jackals_a)
	(ai_place_tracked b5_a_cov/jackals_g)
	(ai_place_tracked b5_a_cov/grunts_c)
	(ai_place_tracked b5_a_cov/grunts_i)
	(sleep 1)
	(objects_predict (ai_actors b5_a_cov))
	)

(script dormant enc_b5_hall
	(ai_place_tracked b5_hall_cov/stealth_elites_a)
	(ai_place_tracked b5_hall_cov/stealth_elites_e)
	(sleep 1)
	(objects_predict (ai_actors b5_hall_cov))
	)

(script dormant enc_b5_b
	(ai_place_tracked b5_b_cov/hunters)
	(sleep 1)
	(objects_predict (ai_actors b5_b_cov))
	)

(script dormant enc_b5_b_reins_1
	(ai_place_tracked b5_b_cov/elites_reins)
	(ai_place_tracked b5_b_cov/jackals_reins)
	(ai_place_tracked b5_b_cov/grunts_reins)
	(sleep 1)
	(objects_predict (ai_actors b5_b_cov))
	)
...
(script dormant enc_c_bridge_banshee
	(ai_place_tracked c_bridge/banshee_a_elite)
	(ai_place_tracked c_bridge/banshee_b_elite)
	(sleep 1)
	(objects_predict (ai_actors c_bridge))
	)
	
(script dormant enc_c_bridge_initial
	(ai_place_tracked c_bridge/elites_a)
	(wake mission_badboys)
	(wake mission_skip)
	
	(begin_random
		(if c_bridge_spawn
			(begin (ai_place_tracked c_bridge/grunts_a1)
		...
		(if c_bridge_spawn
			(begin (ai_place_tracked c_bridge/grunts_a2)
				  (set c_bridge_spawn_counter (+ 1 c_bridge_spawn_counter))
				  (if (= c_bridge_spawn_counter c_bridge_squad_index) (set c_bridge_spawn false))))
		(if c_bridge_spawn
			(begin (ai_place_tracked c_bridge/jackals_a)
				  (set c_bridge_spawn_counter (+ 1 c_bridge_spawn_counter))
				  (if (= c_bridge_spawn_counter c_bridge_squad_index) (set c_bridge_spawn false)))))
...
(script dormant enc_c_bridge_second
	(ai_place_tracked c_bridge/elites_b)
	
	(begin_random
		(if c_bridge_spawn
			(begin (ai_place_tracked c_bridge/grunts_b1)
				  (set c_bridge_spawn_counter (+ 1 c_bridge_spawn_counter))
				  (if (= c_bridge_spawn_counter c_bridge_squad_index) (set c_bridge_spawn false))))
		(if c_bridge_spawn
			(begin (ai_place_tracked c_bridge/grunts_b2)
				  (set c_bridge_spawn_counter (+ 1 c_bridge_spawn_counter))
				  (if (= c_bridge_spawn_counter c_bridge_squad_index) (set c_bridge_spawn false))))
		(if c_bridge_spawn
			(begin (ai_place_tracked c_bridge/jackals_b)
				  (set c_bridge_spawn_counter (+ 1 c_bridge_spawn_counter))
				  (if (= c_bridge_spawn_counter c_bridge_squad_index) (set c_bridge_spawn false)))))
	(set c_bridge_spawn_counter 0)
	(set c_bridge_spawn true)
...
(script dormant enc_c_bridge_reins
	(if (or (= (game_difficulty_get) hard)
		   (= (game_difficulty_get) impossible)) (ai_place_tracked c_bridge/hunter_c))
	(ai_place_tracked c_bridge/grunts_c)
	(sleep 1)
	(objects_predict (ai_actors c_bridge))
...
(script dormant enc_c1_top
	(ai_place_tracked c1_top_cov/grunts_middle)
	(ai_place_tracked c1_top_cov/jackals_c)
	(ai_place_tracked c1_top_cov/jackals_m)
	(sleep 1)
	(objects_predict (ai_actors c1_top_cov))
	)
	
(script dormant enc_c1_bottom
	(ai_place_tracked c1_bottom_cov/grunts_w)
	(ai_place_tracked c1_bottom_cov/stealth_elites)
	(ai_place_tracked c1_bottom_cov/jackals_far)
	(sleep 1)
...
(script dormant enc_ext_c_ghost_pilots
	(ai_place_tracked ext_c_cov/ghost_pilot_a)
;	(ai_place_tracked ext_c_cov/ghost_pilot_b)
	(ai_place_tracked ext_c_cov/ghost_pilot_c)
	(ai_place_tracked ext_c_cov/wraith_pilot)
...
;	(ai_place_tracked ext_c_cov/ghost_pilot_b)
;	(ai_place_tracked ext_c_cov/ghost_pilot_c)
;	(ai_place_tracked ext_c_cov/jackals_s)
;	(ai_place_tracked ext_c_cov/jackals_g)
;	(ai_place_tracked ext_c_cov/grunts_g)
;	(ai_place_tracked ext_c_cov/grunts_o)
;	(ai_place_tracked ext_c_cov/elites_o)
	(ai_place_tracked ext_c_cov/turret_grunts)
	(sleep 1)
	(objects_predict (ai_actors ext_c_cov))
	)

(script dormant enc_ext_c_zig_top
;	(ai_place_tracked zig_cov_top/elite_commander_top)
	(ai_place_tracked zig_cov_top/hunters)
	(ai_place_tracked zig_cov_top/turret_grunts)
	(ai_place_tracked zig_cov_top/grunt_grenaders)
	(ai_place_tracked zig_cov_top/tool_grunts)
	(sleep 1)
	(objects_predict (ai_actors zig_cov_top))
	)

(script dormant enc_ext_c_zig_bottom
	(ai_place_tracked zig_cov_bottom/hunters_a)
	(ai_place_tracked zig_cov_bottom/turret_grunts_a)
	(ai_place_tracked zig_cov_bottom/turret_grunts_b)
	(ai_place_tracked zig_cov_bottom/elites_e)
	(ai_place_tracked zig_cov_bottom/grunts_e)
	(ai_place_tracked zig_cov_bottom/grunts_k)
	(ai_place_tracked zig_cov_bottom/jackals_k)
	(ai_place_tracked zig_cov_bottom/jackals_o)
	(ai_place_tracked zig_cov_bottom/shotguns)
	(sleep 1)
	(objects_predict (ai_actors zig_cov_bottom))
	)

(script dormant enc_control
	(ai_place_tracked control_cov/elites_g)
	(ai_place_tracked control_cov/grunts_g)
	(ai_place_tracked control_cov/elite_commander)
	(ai_place_tracked control_cov/grunts_a)
	(ai_place_tracked control_cov/turret_grunts)
	(sleep 1)
...
;	(ai_place_tracked insertion_cov/grunts_ini)
;	(sleep 90)
...
(script dormant mission_insertion_b
	(wake obj_chasm1)
(ai_place_tracked insertion_cov/grunts_extra )
	(set mission_start 1)
	(sleep 60)
	(ai_set_blind insertion_cov/grunts_extra false)
	(ai_set_deaf insertion_cov/grunts_extra false)
	(sleep_until (= (device_get_position insertion_door) 0))
	(sleep 60)
	(ai_place_tracked insertion_cov/grunts)
	(ai_place_tracked insertion_cov/elites)
...
(script dormant mission_ext_a
	...
	(wake taxi_time) ;; new cursed stuff
;	(wake general_save)
...
;	(wake general_save)
	...
	;;(sleep_until (volume_test_objects zig_trigger_b (players))) ;; skip this in cursed halo
...
;	(ai_conversation_advance insertion)
   ...
   (mcc_mission_segment "12_c1")
	...
	(sleep_until (or (volume_test_objects ext_c_trigger_b (players)) (volume_test_objects ext_c_trigger_b_skip (players))) 10)
	(wake mission_ext_c)
