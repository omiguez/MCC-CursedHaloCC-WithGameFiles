...
(script dormant mission_blam_burn
	...
	(sleep 60)
;	(ai_place_tracked blam/burn_crewman)
...
(script dormant mission_containment_1
	...
	(ai_place_tracked containment_1/rear_security)
	...
	(ai_place_tracked containment_1/rear_crewman)
	...
	(ai_place_tracked containment_1/forward_security)
	...
	(ai_place_tracked containment_1_anti/rear_elite)
	...
	(ai_place_tracked containment_1_anti/forward_elite)
	...
	(ai_place_tracked containment_1/flee_crewman)
	...
	(ai_place_tracked containment_1/doom_crewman)
...
(script dormant mission_crossfire
	...
	(object_cannot_take_damage (ai_actors crossfire))
	(ai_place_tracked crossfire_anti)
...
;	(objects_attach keyesa10 mouth01 pipea10 "")
	...
	(cinematic_stop)  ; Stupid black bars go away so I can have this joke where the pistol goes off
	(sleep 30)
...
;	(sleep (sound_impulse_time cinematics\sound\x20\cor11))
	...
	(object_cannot_take_damage keyesa10)
	(sleep 25)
	(effect_new_on_object_marker "levels\a10\effects\oops pistol fire" pistola10 "primary trigger")   ; Dumb joke added
	(sleep 5)
	(effect_new_on_object_marker "levels\a10\effects\oops pistol" keyesa10 "right hand")
	...
	(sleep 30)
	(object_can_take_damage keyesa10)
	)
...
(script dormant mission_bridge
   ...
   (if (mcc_mission_segment "cine3_bridge_talk") (sleep 1))              
	...
	(sleep_until (or (< (unit_get_health keyesa10) 0.1)
...
(script dormant mission_cafeteria
	...
	(ai_place_tracked cafeteria/init_marine)
	(objects_predict (ai_actors cafeteria))
	(ai_place_tracked cafeteria_anti/init_elite)
	(object_cannot_take_damage (ai_actors cafeteria_anti/init_elite))
	(ai_place_tracked cafeteria_anti/init_grunt)
   ...
   (mcc_mission_segment "05_cafeteria")
	...
	(ai_place_tracked cafeteria/rein_marine)
	...
	(ai_place_tracked cafeteria_anti/flank)
	(ai_place_tracked cafeteria_anti/retreat_grunt)
...
(script dormant mission_airlock_1
   ...
   (mcc_mission_segment "06_airlock1")
	(ai_place_tracked airlock_1)
	(units_set_current_vitality (ai_actors airlock_1/airlock_marine) 1 0)
	(ai_place_tracked airlock_1_anti/backstab_elite)
	...
	(sleep 2)
	(ai_place_tracked airlock_1_anti/boarding)
...
(script dormant mission_flank
   ...
   (mcc_mission_segment "06_flank")
	(sleep 5)
	(ai_place_tracked flank)
	(ai_place_tracked flank_anti/init)
	...
	(sleep_until (or (< (ai_living_count flank_anti/init) 2)
				  (volume_test_objects flank_trigger_3 (players))) 1)
	(ai_place_tracked flank_anti/rein)
	(ai_place_tracked flank_anti/last_grunt)
...
(script dormant mission_loop
   ...
   (mcc_mission_segment "07_loop")
	(ai_place_tracked loop)
	(ai_braindead loop/doom_crewman 1)
	(ai_place_tracked loop_anti/init)
	...
	(object_pvs_clear)
	(ai_place_tracked loop_anti/search_grunt)
...
(script dormant mission_airlock_2
   ...
   (mcc_mission_segment "08_airlock2")
	(ai_place_tracked airlock_2_anti/init)
	...
	(sleep_until (volume_test_objects airlock_2_trigger_1 (players)) 1)
	(ai_place_tracked airlock_2_anti/rein)
	(set play_music_a10_05_alt false)
	)
...
(script dormant mission_knot
   ...
   (mcc_mission_segment "09_knot")
	...
	(ai_place_tracked knot)
	(ai_place_tracked knot_anti)
...
(script dormant mission_stairs
	(device_set_position stairs_entrance_door 1)
	(game_save)
   (mcc_mission_segment "10_stairs")
	(ai_place_tracked stairs/init)
	(ai_place_tracked stairs_anti/init)
	...
	(sleep_until (or (> 4 (ai_living_count stairs_anti/init))
 	...
 	(ai_place_tracked stairs_anti/lower)
	...
	(sleep_until (or (and (> 4 (ai_living_count stairs_anti/init))
				  ...
				  (volume_test_objects stairs_trigger_2 (players))) 1)
	(ai_place_tracked stairs_anti/upper)
...
(script dormant mission_containment_2
   ...
   (mcc_mission_segment "11_containment2")
	(ai_place_tracked containment_2_anti)
	(ai_migrate stairs containment_2)
	(ai_follow_target_players containment_2)
	)
...
(script dormant mission_lifepod_1
   ...
   (mcc_mission_segment "12_lifepod")
	(ai_place_tracked lifepod_1_anti)
	)
...
(script dormant mission_tunnel
   ...
   (mcc_mission_segment "13_tunnel")
	...
	(ai_place_tracked tunnel_anti/rear)
	(ai_place_tracked tunnel_anti/forward)
...
(script dormant mission_final
   ...
   (mcc_mission_segment "16_final1")
	...
	(ai_place_tracked containment_3_anti/1)
	(ai_place_tracked containment_3_anti/2)
	(ai_place_tracked containment_3)
	...
	(ai_place_tracked containment_3_anti/3)
	(ai_place_tracked containment_3_anti/4)
	(ai_place_tracked containment_3_anti/5)
   ...
   (mcc_mission_segment "16_final2")
	...
	(ai_place_tracked lifepod_2)
	(ai_place_tracked lifepod_2_anti)
...
(script dormant fast_setup
	...
	(ai_place_tracked cryo_tech/tech)
...
(script startup mission_a10
   ...
   (mcc_mission_segment "03_escape")
	...
	(wake mission_knot)
	(wake mission_karate)         ;; Originally this was mission_stairs but we have a cutscene with johnson before that part. we wake mission stairs in the mission karate script
